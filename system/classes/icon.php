...
class Icon
{
	public function convert($img_path,$size = 16,$new_path = '')
	{
		$_gd_array = $this->do_gd($img_path,$size);

		if(!$_gd_array) return FALSE;

		$icon_data = $this->to_str($_gd_array);
	...
	public function do_gd($img_path,$size = 16)
	{
	...
	public function to_str(&$gd_ico_array)
	{
	...
	public function le2s($number, $minbytes=1)
	{
		$intstring = '';
