...
if (!class_exists('Xmlrpc')) message('You must load the Xmlrpc class before loading the Xmlrpcs class in order to create a server.');
		...
		if ($objectCall === TRUE)
		{
			...
			else
			{
				if ($this->object === FALSE)
				{
					...
					message('Please check class Xmlrpcs in line 344-348');
				}
				else
				{
